      ...
      <div class="col-md-8 col-lg-6 col-xl-4">
        ...
        <div class="card mt-2" style="border-radius: 15px;">
          <div class="card-header d-flex justify-content-between align-items-center p-3 text-white border-bottom-0"
            style="border-top-left-radius: 15px; border-top-right-radius: 15px;background-color:#2d90e2">
            <i class="fas fa-angle-left"></i>
            <p class="mb-0 fw-bold">Ask ChatGenerator</p>
            <i class="fas fa-times"></i>
          </div>
          <div class="card-body">
            <div id="chat-box" style="height: 480px" class="overflow-auto p-3"></div>
            ...
            <div class="form-outline">
              <form id="ask-chatgpt-form">
                ...
                <button type="submit" id="submit-btn" style="background-color:#2d90e2"
...
<template id="user-message-box-template">
  <div class="d-flex flex-row justify-content-end mb-4">
    ...
    <img class="ml-2" src="{{ asset('images/2.png') }}" alt="avatar-icon" style="width: 30px; height: 100%;">
  </div>
</template>

<template id="chatgpt-message-box-template">
  <div class="d-flex flex-row justify-content-start mb-4">
    <img src="{{ asset('images/1.png') }}" alt="open-ai-logo" class="mr-2"
